...
<p>
  Download <code>code-trace-tree-skill-1.2.2.zip</code> from the GitHub Release
...
<pre><code>curl -L https://github.com/saidake/code-trace-tree-vscode/releases/download/v1.2.2/code-trace-tree-skill-1.2.2.zip -o code-trace-tree-skill-1.2.2.zip</code>
<code>rm -rf ~/.claude/skills/code-trace-tree</code>
<code>mkdir -p ~/.claude/skills</code>
<code>unzip code-trace-tree-skill-1.2.2.zip -d ~/.claude/skills/</code>
<code>rm code-trace-tree-skill-1.2.2.zip</code>
</pre>
...
<pre><code>Invoke-WebRequest -Uri "https://github.com/saidake/code-trace-tree-vscode/releases/download/v1.2.2/code-trace-tree-skill-1.2.2.zip" -OutFile "code-trace-tree-skill-1.2.2.zip"</code>
...
<code>Expand-Archive -Path "code-trace-tree-skill-1.2.2.zip" -DestinationPath "$HOME\.claude\skills" -Force</code>
<code>Remove-Item "code-trace-tree-skill-1.2.2.zip"</code>
</pre>
